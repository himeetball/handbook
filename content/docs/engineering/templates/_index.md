+++
title = "PR Templates"
description = "Standardized pull request templates for different types of changes"
draft = false
weight = 1
sort_by = "weight"
+++
...
### 🎫 [Git Issue Ticket Template](@/docs/engineering/templates/git-issue-ticket.md)
...
### 📝 [PR Template](@/docs/engineering/templates/pr-template.md)
...
### 🔍 [Spike/Feature R&D Template](@/docs/engineering/templates/spike-feature-rd.md)
...
### 🐛 [Bug Reporting Template](@/docs/engineering/templates/bug-reporting.md)
...
- **Creating issues** → Git Issue Ticket Template
- **All pull requests** → PR Template
- **Research/exploration** → Spike/Feature R&D Template
- **Reporting bugs** → Bug Reporting Template
