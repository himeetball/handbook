...
description = "Complete guide for new engineering contributors joining MeetBall's open startup project"
...
[extra]
lead = "Welcome to MeetBall Engineering! This guide will help you get started as a contributor in our open startup environment."
toc = true
top = false
+++
...
5. **[Ecosystem eagle-view](./engineering.md)**: 10 000 feet-view of the main modules
...
```
👋 Hi everyone! I'm [Name], joining as a [Role] and I am a [Career Ladder]
...
🚀 You can reach me @ [email or social(s)]
```
...
- **Report Feebadk**: TBD
- **Email**: [support@meetball.fun] for formal communications
