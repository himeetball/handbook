...
1. **Initial hypothesis and setup** (when created on Plane)
2. **Execution notes** (during the experiment - Comments on Plane)
3. **Results and analysis** (when complete - Final comment on Plane)
4. **Archive status** (Positive/Negative/Inconclusive)
...
5. Document results and lead the review discussion
6. Archive with clear status for future reference
...
- [Experimentation Resources - GitHub](https://github.com/DavisTrey/ExperimentationResources)
- [Culture of Experimentation - Statsig](https://www.statsig.com/blog/culture-of-experimentation)
- [How to Build a Culture of Experimentation - AWS](https://aws.amazon.com/blogs/enterprise-strategy/how-can-you-build-a-culture-of-experimentation/)
- [Amazon's Experimentation Approach - Conversion Rate Experts](https://conversion-rate-experts.com/amazon/)

---

_This framework is a living document. As an open startup, we invite feedback and contributions to improve how we experiment together. The goal is to create a system that encourages bold ideas while maintaining the focus needed to build something our users love._
